...
const BackgroundSlideshow: React.FC<{ images: string[]; alt: string }> = ({
  images,
  alt,
}) => {
      ...
      <div className="fixed inset-0 bg-luxora-dark z-[9999] flex flex-col items-center justify-center px-6 transition-opacity duration-700">
        <div className="w-full max-w-xs flex flex-col items-center">
          <img
            src="/logo_Lg.png"
            alt="Luxora Logo"
            className="h-32 md:h-64 w-auto object-contain animate-pulse mb-12"
          />
          ...
          <div className="w-full flex flex-col items-center space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="mt-2 text-[8px] text-white/20 uppercase tracking-[0.4em]">
                Refining Excellence
              </div>
            </div>
          </div>
          ...
          <section className="relative pt-32 pb-48 bg-luxora-dark min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
            <BackgroundSlideshow
              images={[
                ...
                "/images/fleet/properties/2.jpg",
                "/images/fleet/properties/3.jpg",
              ]}
              alt="Elite Mansion"
            />
          ...
          <section className="relative pt-32 pb-48 bg-luxora-dark min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
            <BackgroundSlideshow
              images={[
                ...
                "/images/fleet/yacht/2.jpg",
                "/images/fleet/yacht/3.jpg",
              ]}
              alt="Super Yacht"
            />
            <div className="relative z-10 text-center">
