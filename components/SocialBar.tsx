...
const SocialBar: React.FC = () => {
  return (
    <div className="fixed left-6 bottom-0 z-40 hidden lg:flex flex-col items-center space-y-6">
      <div className="flex flex-col space-y-6 mb-4">
        <a 
          href="https://www.instagram.com/luxurycarrentalsbangalore/" 
          target="_blank" 
          rel="noopener noreferrer"
          className="text-white/40 hover:text-luxora-gold transition-all duration-300 transform hover:-translate-y-1"
      ...
      <span className="text-[10px] uppercase tracking-[0.4em] text-luxora-gold font-bold vertical-text py-4 select-none opacity-50">
        Follow Us
      </span>
